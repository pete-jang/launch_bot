...
CREATE TABLE IF NOT EXISTS orders (
  ...
  meal_date DATE NOT NULL COMMENT '식사 날짜 (KST)',
  ...
  -- 동일한 식사일에 같은 사용자가 중복 주문하지 못하도록 제약
  UNIQUE KEY unique_daily_order (meal_date, user_id)
...
CREATE TABLE IF NOT EXISTS order_sessions (
  meal_date DATE PRIMARY KEY COMMENT '식사 날짜 (KST)',
